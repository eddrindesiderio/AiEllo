#!/usr/bin/env python3
"""
Discord Bot - BlackBox AI Fixed Version
This version uses the correct BlackBox AI API format.
...
Run with: python deployment/discord_bot_blackbox_fixed.py
"""
...
# BlackBox AI API call with multiple endpoint attempts
async def get_ai_response(message):
    """Get AI response from BlackBox AI using multiple endpoint attempts"""
    ...
    for i, config in enumerate(endpoints_and_formats, 1):
        try:
            print(f"🔍 Trying BlackBox AI endpoint {i}: {config['url']}")
                ...
                async with session.post(
                    ...
                    if response.status == 200:
                        ...
                        try:
                            ...
                            print(f"✅ BlackBox AI Success: {ai_response[:50]}...")
                            return ai_response
                            
                        except json.JSONDecodeError:
                            # If not JSON, return raw text
                            if response_text.strip():
                                print(f"✅ BlackBox AI Raw Response: {response_text[:50]}...")
    ...
    print("❌ All BlackBox AI endpoints failed - using fallback")
    return get_fallback_response(message)
...
async def on_ready():
    ...
    print("🔥 Powered by BlackBox AI (Multiple Endpoint Testing)")
...
async def on_message(message):
    ...
    try:
        ...
        # Help command
            ...
            help_text = """🤖 **Personal AI Assistant - BlackBox AI Fixed Version**
...
**Features:**
✅ Powered by BlackBox AI (Multiple Endpoints)
...
**Note:** This bot tests multiple BlackBox AI endpoints to find the working one!"""
...
def main():
    """Run the bot"""
    print("🚀 Starting BlackBox AI Discord Bot (Fixed Version)...")
    print("🔧 Features:")
    print("   - CLEAN MESSAGE HANDLING")
    print("   - ABSOLUTELY NO DUPLICATE RESPONSES")
    print("   - Rate limiting protection")
    print("   - BlackBox AI integration (Multiple Endpoints)")
